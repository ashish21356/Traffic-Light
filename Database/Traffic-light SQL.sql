...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2024 at 01:16 PM
...
-- Database: `abc-school`
--
CREATE DATABASE IF NOT EXISTS `abc-school` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `abc-school`;
...
CREATE TABLE `admissions` (
  ...
  `media_file` varchar(170) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `admissions` (`id`, `student_name`, `dob`, `gender`, `address`, `parent_name`, `contact`, `email`, `previous_school`, `grade`, `media_file`) VALUES
(1, 'hgyft', '2020-06-17', 'female', 'rgg', 'gtrg', '7047626500', 'ashishwadbuddfefdfdewrf1ffchgxg56@gmail.com', '', 'kg', ''),
(2, 'th', '2021-01-07', 'male', 'thgrt', 'ty', '6776567654', 'ashishwadbude@gmail.com', 'fdg', 'nursery', ''),
(3, 'grg', '2021-02-03', 'male', 'yhnygh', 'hj', '7657657556', 'ashishwagfdbude@gmail.com', 'gbf', 'kg', ''),
(4, 'ghf', '2021-02-02', 'female', 'fgg', 'hghgf', '7657567657', 'ashishwadbudecv16@gmail.com', 'vb', 'grade1', ''),
(5, 'ghf', '2021-02-02', 'female', 'fgg', 'hghgf', '7657567657', 'ashishwgadbudecv16@gmail.com', 'vb', 'grade1', ''),
(6, 'yj', '2021-03-11', 'male', 'jh', 'hghg', '67576576565', 'johndoehg@gmail.com', 'hg', 'kg', ''),
(7, 'fvgd', '2021-03-04', 'male', 'gbvb', 'fvb', '6578567657', 'joh5ndoe@gmail.com', 'thfth', 'kg', ''),
(8, 'fvgd', '2021-03-04', 'male', 'gbvb', 'fvb', '6578567657', 'joh5ncdoe@gmail.com', 'thfth', 'kg', ''),
(9, 'hgyft', '2021-02-10', 'female', 'ghg', 'hgfgh', '7876565454', 'ghfgfa@gmail.com', 'hjghj', 'grade1', ''),
(10, 'bfcb', '2021-05-03', 'other', 'dfvd', 'fghfg', '64564564564', 'ashishwfdadbude16@gmail.com', 'fdgfd', 'grade2', ''),
(11, 'hgf', '2021-04-03', 'male', 'ghfhfg', 'htffgh', '6756756765', 'ashishwadfghbude16@gmail.com', 'hfgh', 'kg', ''),
(12, 'hgyft', '2021-03-26', 'male', 'fghf', 'ghfh', '765756756756', 'ashishwafgdbude@gmail.com', 'hfghf', 'kg', ''),
(13, 'ghf', '2021-02-05', 'male', 'vcfb chgtr', 'hgjhg', '5657890987', 'ashishw45adbude16@gmail.com', 'y', 'grade1', 'uploads/ASHISH_WADBUDE_(1).png');
...
('WvCE2qO9y3T9RqJXBFcXuUC1UG5bPo4762edUJQK', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiYXQxUkRRcDhVVlVXcVdMd3VYb3Z1cHdCVzhXN3NHYXQzTFRBaDljeCI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzI6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9hZG1pbi91c2VyIjt9czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1724763087);
...
--
CREATE DATABASE IF NOT EXISTS `duraface-solutions` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `duraface-solutions`;
...
-- Database: `laratut`
--
CREATE DATABASE IF NOT EXISTS `laratut` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `laratut`;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"trafficsignal\",\"table\":\"sequence\"},{\"db\":\"trfficlight\",\"table\":\"sequences\"},{\"db\":\"abc-school\",\"table\":\"admin_users\"},{\"db\":\"abc-school\",\"table\":\"admissions\"}]');
...
('root', '2024-09-09 11:16:24', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":242}');
...
--
CREATE DATABASE IF NOT EXISTS `trafficsignal` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `trafficsignal`;
